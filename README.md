...
This repo is the public, MIT-licensed slice of that idea. Token Factory is the required runtime; Hermes stays on a local default model until an explicit triage session.
...
| Public repo + OSS license | MIT — publish before submit |
